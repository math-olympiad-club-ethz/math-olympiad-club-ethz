...
\\\\
Summarizing, the only possible polynomials \( P(X)\in\mathbb{Z}[X] \) satisfying the given conditions are \( X \), and otherwise they have degree \( 2 \) or \( 3 \) with a constant term \( 0 \) and negative roots.
\\\\
