...
\[
\langle v, Av \rangle_{\mathbb{F}_2^n} = \sum_{0 \leq i, j \leq n-1} v_i v_j a_{ij} = \sum_{i=1}^n v_i^2 + 2 \sum_{0\leq i < j\leq n-1} v_i v_j a_{ij} = \sum_{i=0}^{n-1} v_i = \left\langle v, 1_{\mathbb{F}_2^n} \right\rangle_{\mathbb{F}_2^n},
\]
because we are working over \( \mathbb{F}_2 \). In particular for any \( z \in \operatorname{Im}(A)^\perp\subset \mathbb{F}_2^n \),
\[
\langle z, \underline{1} \rangle_{\mathbb{F}_2^n} = \langle z, Az \rangle_{\mathbb{F}_2^n} = 0_{\mathbb{F}_2},
\]
