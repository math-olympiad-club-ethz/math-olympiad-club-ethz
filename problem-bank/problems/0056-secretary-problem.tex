...
\end{problem}
\begin{solution}
i. Réponse: elle décide de rejeter les $N / 2$ premiers prétendants et de se marier avec le premier parmi les $N / 2$ derniers qui est mieux que les $N / 2$ premiers prétendants (s'il existe). Cette stratégie a probabilité $\geq \frac{1}{4}$ de fonctionner, car la chance que le dauphin (le prétendant qui est juste en dessous du prince charmant) soit dans le $N / 2$ premiers est $\frac{1}{2}$ et la chance que le prince charmant soit dans les $N / 2$ derniers est $\frac{1}{2}$ aussi. Comme les deux événements sont (presque) indépendants ( $N$ assez grand) la probabilité qu'ils se produisent les deux est $\approx \frac{1}{4}$ et dans ce cas de figure la princesse trouve en effet le prince charmant.\\
