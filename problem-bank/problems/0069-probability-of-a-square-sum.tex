...
$$=\left(\frac{\lfloor\sqrt{n}\rfloor(\lfloor\sqrt{n}\rfloor+1)(2\lfloor\sqrt{n}\rfloor+1)-6\lfloor\sqrt{n}\rfloor + 6(2n+1)\left(\lfloor\sqrt{2n}\rfloor-\lfloor\sqrt{n}\rfloor\right)}{6}\right)-\sum_{i=\lfloor\sqrt{n}\rfloor + 1}^{\lfloor\sqrt{2n}\rfloor}i^2$$
$$=\left(\frac{\lfloor\sqrt{n}\rfloor(\lfloor\sqrt{n}\rfloor+1)(2\lfloor\sqrt{n}\rfloor+1)-6\lfloor\sqrt{n}\rfloor + 6(2n+1)\left(\lfloor\sqrt{2n}\rfloor-\lfloor\sqrt{n}\rfloor\right)}{6}\right)$$
