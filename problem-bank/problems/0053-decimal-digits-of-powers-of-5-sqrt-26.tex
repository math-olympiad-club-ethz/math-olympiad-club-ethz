...
\end{problem}
\begin{solution}
It is clear that ${(5 + \sqrt{26})}^{n} + {(5 - \sqrt{26})}^{n}$ is an integer, whether by expanding the products and noting that all odd powers of $\sqrt{26}$ cancel, or by using Galoi theory - sum of algebraic integers is algebraic integer, sum of all roots is a rational, rational algebraic integer is integer.\\
